const task1 = function () {
    if (task1N.value.length === 0 || task1M.value.length === 0) {
        alert("ЗАДАНИЕ 1: Введите значения n и m.")
    } else {
...
const task2 = function () {
    if (task2N.value.length === 0) {
        alert("ЗАДАНИЕ 2: Введите значения n.")
    } else if (task2M.value.length === 0){
