...
// Левая сторона неравенства равна строке "32", так как происходит конкатинация строк.
// Правая сторона неравенства равна числу 5 так как 3 и 2 это числа и к ним приминяется числовой оператор добавления.
...
// Проверка 'x' == 'x' будет равна значению true, поєтому в результате получим массив из одного элемента.
